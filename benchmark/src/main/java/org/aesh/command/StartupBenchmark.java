...
public class StartupBenchmark {
    ...
    static {
        try {
            REFLECTION_CREATE = AeshCommandContainerBuilder.class.getDeclaredMethod("doGenerateCommandLineParser", Command.class);
    ...
    @GroupCommandDefinition(name = "grp-1", description = "Group 1", groupCommands = { AeshGrpChild1a.class, AeshGrpChild1b.class })
    ...
    @GroupCommandDefinition(name = "grp-2", description = "Group 2", groupCommands = { AeshGrpChild2a.class, AeshGrpChild2b.class }, defaultValueProvider = BenchmarkDefaultValueProvider.class)
    ...
    @GroupCommandDefinition(name = "grp-3", description = "Group 3", groupCommands = { AeshGrpChild3a.class, AeshGrpChild3b.class }, stopAtFirstPositional = true)
    ...
    @GroupCommandDefinition(name = "grp-4", description = "Group 4", groupCommands = { AeshGrpChild4a.class, AeshGrpChild4b.class })
    ...
    @GroupCommandDefinition(name = "grp-5", description = "Group 5", groupCommands = { AeshGrpChild5a.class, AeshGrpChild5b.class })
    ...
    @GroupCommandDefinition(name = "mid", description = "Mid level", groupCommands = { AeshLeafCmd1.class, AeshLeafCmd2.class })
    ...
    @CommandLine.Command(name = "mid", description = "Mid level", subcommands = { PicoLeafCmd1.class, PicoLeafCmd2.class })
    ...
    private static final Class<? extends Command<CommandInvocation>>[] AESH_COMMANDS = new Class[] { AeshCmd1.class, AeshCmd2.class, AeshCmd3.class, AeshCmd4.class, AeshCmd5.class, AeshCmd6.class, AeshCmd7.class, AeshCmd8.class, AeshCmd9.class, AeshCmd10.class };

    private static final Class<? extends Runnable>[] PICO_COMMANDS = new Class[] { PicoCmd1.class, PicoCmd2.class, PicoCmd3.class, PicoCmd4.class, PicoCmd5.class, PicoCmd6.class, PicoCmd7.class, PicoCmd8.class, PicoCmd9.class, PicoCmd10.class };

    private static final Class<? extends Command<CommandInvocation>>[] AESH_GROUP_COMMANDS = new Class[] { AeshGrpCmd1.class, AeshGrpCmd2.class, AeshGrpCmd3.class, AeshGrpCmd4.class, AeshGrpCmd5.class };

    private static final Class<? extends Runnable>[] PICO_GROUP_COMMANDS = new Class[] { PicoGrpCmd1.class, PicoGrpCmd2.class, PicoGrpCmd3.class, PicoGrpCmd4.class, PicoGrpCmd5.class };

    private static final Class<? extends Command<CommandInvocation>>[] AESH_MIXIN_COMMANDS = new Class[] { AeshMixCmd1.class, AeshMixCmd2.class, AeshMixCmd3.class, AeshMixCmd4.class, AeshMixCmd5.class, AeshMixCmd6.class, AeshMixCmd7.class, AeshMixCmd8.class, AeshMixCmd9.class, AeshMixCmd10.class };

    private static final Class<? extends Runnable>[] PICO_MIXIN_COMMANDS = new Class[] { PicoMixCmd1.class, PicoMixCmd2.class, PicoMixCmd3.class, PicoMixCmd4.class, PicoMixCmd5.class, PicoMixCmd6.class, PicoMixCmd7.class, PicoMixCmd8.class, PicoMixCmd9.class, PicoMixCmd10.class };

    private static final Class<? extends Command<CommandInvocation>>[] AESH_VARIETY_COMMANDS = new Class[] { AeshListGroupCmd.class, AeshHelpCmd.class, AeshVersionCmd.class };

    private static final Class<? extends Runnable>[] PICO_VARIETY_COMMANDS = new Class[] { PicoListGroupCmd.class, PicoHelpCmd.class, PicoVersionCmd.class };
    ...
    private CommandContainer<CommandInvocation> createGeneratedMixinContainer(String name, int index) throws Exception {
        Command<CommandInvocation> cmd = AESH_MIXIN_COMMANDS[index % AESH_MIXIN_COMMANDS.length].getDeclaredConstructor().newInstance();
        ProcessedCommand<Command<CommandInvocation>, CommandInvocation> pc = ProcessedCommandBuilder.<Command<CommandInvocation>, CommandInvocation>builder().name(name).description("Mixin command " + name).command(cmd).// Mixin-sourced options (tagged with mixinFieldName)
        addOption(ProcessedOptionBuilder.builder().shortName('v').name("verbose").description("Verbose").type(boolean.class).fieldName("verbose").optionType(OptionType.BOOLEAN).negatable(true).mixinFieldName("common").build()).addOption(ProcessedOptionBuilder.builder().shortName('o').name("output").description("Output path").type(String.class).fieldName("output").optionType(OptionType.NORMAL).mixinFieldName("common").build()).// Command's own options
        addOption(ProcessedOptionBuilder.builder().shortName('r').name("recursive").description("Recursive").type(boolean.class).fieldName("recursive").optionType(OptionType.BOOLEAN).build()).addOption(ProcessedOptionBuilder.builder().name("bufferSize").description("Buffer size").type(int.class).fieldName("bufferSize").optionType(OptionType.NORMAL).addDefaultValue("4096").build()).create();
        pc.setArgument(ProcessedOptionBuilder.builder().shortName('\u0000').name("").description("Source path").type(String.class).fieldName("source").optionType(OptionType.ARGUMENT).build());
    ...
    private void buildAeshRuntimeMixinReflection(int commandCount) throws Exception {
        ...
        AeshCommandContainerBuilder<CommandInvocation> containerBuilder = new AeshCommandContainerBuilder<>();
        for (int i = 0; i < commandCount; i++) {
            Command<CommandInvocation> cmd = AESH_MIXIN_COMMANDS[i % AESH_MIXIN_COMMANDS.length].getDeclaredConstructor().newInstance();
            CommandContainer<CommandInvocation> container = (CommandContainer<CommandInvocation>) REFLECTION_CREATE.invoke(containerBuilder, cmd);
    ...
    private CommandSpec createPicocliProgrammaticMixinCommand(String name) {
        ...
        spec.addOption(OptionSpec.builder("-v", "--verbose").type(boolean.class).description("Verbose").build());
        spec.addOption(OptionSpec.builder("-o", "--output").type(String.class).description("Output path").build());
        spec.addOption(OptionSpec.builder("-r", "--recursive").type(boolean.class).description("Recursive").build());
        spec.addOption(OptionSpec.builder("--buffer-size").type(int.class).description("Buffer size").defaultValue("4096").build());
        spec.addPositional(PositionalParamSpec.builder().type(String.class).description("Source path").build());
        return spec;
    }
    ...
    private CommandContainer<CommandInvocation> createGeneratedContainer(String name, int index) throws Exception {
        Command<CommandInvocation> cmd = AESH_COMMANDS[index % AESH_COMMANDS.length].getDeclaredConstructor().newInstance();
        boolean useStopAtFirst = (index % 3 == 0);
        boolean useDefaultValueProvider = (index % 5 == 0);
        ProcessedCommandBuilder<Command<CommandInvocation>, CommandInvocation> builder = ProcessedCommandBuilder.<Command<CommandInvocation>, CommandInvocation>builder().name(name).description("Command " + name).command(cmd).stopAtFirstPositional(useStopAtFirst).addOption(ProcessedOptionBuilder.builder().shortName('o').name("output").description("Output path").type(String.class).fieldName("output").optionType(OptionType.NORMAL).optionalValue(true).addDefaultValue("/tmp/out").build()).addOption(ProcessedOptionBuilder.builder().shortName('r').name("recursive").description("Recursive").type(boolean.class).fieldName("recursive").optionType(OptionType.BOOLEAN).negatable(true).build()).addOption(ProcessedOptionBuilder.builder().name("bufferSize").description("Buffer size").type(int.class).fieldName("bufferSize").optionType(OptionType.NORMAL).addDefaultValue("4096").build());
    ...
    private void buildAeshRuntimeReflection(int commandCount) throws Exception {
        ...
        AeshCommandContainerBuilder<CommandInvocation> containerBuilder = new AeshCommandContainerBuilder<>();
        for (int i = 0; i < commandCount; i++) {
            Command<CommandInvocation> cmd = AESH_COMMANDS[i % AESH_COMMANDS.length].getDeclaredConstructor().newInstance();
            CommandContainer<CommandInvocation> container = (CommandContainer<CommandInvocation>) REFLECTION_CREATE.invoke(containerBuilder, cmd);
            registry.addCommand(container);
        }
        AeshCommandRuntimeBuilder.builder().commandRegistry(registry).build();
    ...
    private CommandContainer<CommandInvocation> createGeneratedGroupContainer(String name, int index) throws Exception {
        ...
        Command<CommandInvocation> parentCmd = AESH_COMMANDS[index % AESH_COMMANDS.length].getDeclaredConstructor().newInstance();
        ProcessedCommand<Command<CommandInvocation>, CommandInvocation> parentPc = ProcessedCommandBuilder.<Command<CommandInvocation>, CommandInvocation>builder().name(name).description("Group " + name).command(parentCmd).addOption(ProcessedOptionBuilder.builder().shortName('f').name("format").description("Format").type(String.class).fieldName("output").optionType(OptionType.NORMAL).inherited(true).build()).addOption(ProcessedOptionBuilder.builder().shortName('v').name("verbose").description("Verbose").type(boolean.class).fieldName("recursive").optionType(OptionType.BOOLEAN).inherited(true).negatable(true).build()).create();
        AeshCommandContainer<CommandInvocation> parentContainer = new AeshCommandContainer<>(parentPc);
        // Create child A
        Command<CommandInvocation> childACmd = AESH_COMMANDS[(index + 1) % AESH_COMMANDS.length].getDeclaredConstructor().newInstance();
        ProcessedCommand<Command<CommandInvocation>, CommandInvocation> childAPc = ProcessedCommandBuilder.<Command<CommandInvocation>, CommandInvocation>builder().name(name + "-childA").description("Child A of " + name).command(childACmd).addOption(ProcessedOptionBuilder.builder().shortName('i').name("input").description("Input").type(String.class).fieldName("output").optionType(OptionType.NORMAL).build()).addOption(ProcessedOptionBuilder.builder().shortName('d').name("debug").description("Debug").type(boolean.class).fieldName("recursive").optionType(OptionType.BOOLEAN).build()).create();
        childAPc.setArgument(ProcessedOptionBuilder.builder().shortName('\u0000').name("").description("Source").type(String.class).fieldName("source").optionType(OptionType.ARGUMENT).build());
        AeshCommandContainer<CommandInvocation> childAContainer = new AeshCommandContainer<>(childAPc);
        // Create child B
        Command<CommandInvocation> childBCmd = AESH_COMMANDS[(index + 2) % AESH_COMMANDS.length].getDeclaredConstructor().newInstance();
        ProcessedCommand<Command<CommandInvocation>, CommandInvocation> childBPc = ProcessedCommandBuilder.<Command<CommandInvocation>, CommandInvocation>builder().name(name + "-childB").description("Child B of " + name).command(childBCmd).addOption(ProcessedOptionBuilder.builder().shortName('n').name("name").description("Name").type(String.class).fieldName("output").optionType(OptionType.NORMAL).build()).addOption(ProcessedOptionBuilder.builder().name("count").description("Count").type(int.class).fieldName("bufferSize").optionType(OptionType.NORMAL).addDefaultValue("10").build()).create();
        childBPc.setArgument(ProcessedOptionBuilder.builder().shortName('\u0000').name("").description("Target").type(String.class).fieldName("source").optionType(OptionType.ARGUMENT).build());
    ...
    private void buildAeshRuntimeGroupReflection(int groupCount) throws Exception {
        ...
        AeshCommandContainerBuilder<CommandInvocation> containerBuilder = new AeshCommandContainerBuilder<>();
        for (int i = 0; i < groupCount; i++) {
            Command<CommandInvocation> cmd = AESH_GROUP_COMMANDS[i % AESH_GROUP_COMMANDS.length].getDeclaredConstructor().newInstance();
            CommandContainer<CommandInvocation> container = (CommandContainer<CommandInvocation>) REFLECTION_CREATE.invoke(containerBuilder, cmd);
            registry.addCommand(container);
        }
        AeshCommandRuntimeBuilder.builder().commandRegistry(registry).build();
    ...
    private CommandLine createPicocliProgrammaticGroup(String name) {
        ...
        parentSpec.addOption(OptionSpec.builder("-f", "--format").type(String.class).description("Format").build());
        parentSpec.addOption(OptionSpec.builder("-v", "--verbose").type(boolean.class).description("Verbose").build());
        CommandLine parent = new CommandLine(parentSpec);
        // Child A
        CommandSpec childASpec = CommandSpec.create();
        childASpec.name(name + "-childA");
        childASpec.addOption(OptionSpec.builder("-i", "--input").type(String.class).description("Input").build());
        childASpec.addOption(OptionSpec.builder("-d", "--debug").type(boolean.class).description("Debug").build());
        childASpec.addPositional(PositionalParamSpec.builder().type(String.class).description("Source").build());
        ...
        childBSpec.addOption(OptionSpec.builder("-n", "--name").type(String.class).description("Name").build());
        childBSpec.addOption(OptionSpec.builder("--count").type(int.class).description("Count").defaultValue("10").build());
        childBSpec.addPositional(PositionalParamSpec.builder().type(String.class).description("Target").build());
    ...
    @SuppressWarnings("unused")
    private CommandContainer<CommandInvocation> createGeneratedNestedGroupContainer(String name, int index) throws Exception {
        // Top-level group
        Command<CommandInvocation> topCmd = AESH_COMMANDS[index % AESH_COMMANDS.length].getDeclaredConstructor().newInstance();
        ProcessedCommand<Command<CommandInvocation>, CommandInvocation> topPc = ProcessedCommandBuilder.<Command<CommandInvocation>, CommandInvocation>builder().name(name).description("Top " + name).command(topCmd).addOption(ProcessedOptionBuilder.builder().shortName('g').name("global").description("Global flag").type(boolean.class).fieldName("recursive").optionType(OptionType.BOOLEAN).build()).create();
        AeshCommandContainer<CommandInvocation> topContainer = new AeshCommandContainer<>(topPc);
        // Mid-level group
        Command<CommandInvocation> midCmd = AESH_COMMANDS[(index + 1) % AESH_COMMANDS.length].getDeclaredConstructor().newInstance();
        ProcessedCommand<Command<CommandInvocation>, CommandInvocation> midPc = ProcessedCommandBuilder.<Command<CommandInvocation>, CommandInvocation>builder().name(name + "-mid").description("Mid " + name).command(midCmd).addOption(ProcessedOptionBuilder.builder().shortName('r').name("region").description("Region").type(String.class).fieldName("output").optionType(OptionType.NORMAL).build()).create();
        AeshCommandContainer<CommandInvocation> midContainer = new AeshCommandContainer<>(midPc);
        // Leaf 1
        Command<CommandInvocation> leaf1Cmd = AESH_COMMANDS[(index + 2) % AESH_COMMANDS.length].getDeclaredConstructor().newInstance();
        ProcessedCommand<Command<CommandInvocation>, CommandInvocation> leaf1Pc = ProcessedCommandBuilder.<Command<CommandInvocation>, CommandInvocation>builder().name(name + "-leaf1").description("Leaf 1 of " + name).command(leaf1Cmd).addOption(ProcessedOptionBuilder.builder().shortName('n').name("name").description("Name").type(String.class).fieldName("output").optionType(OptionType.NORMAL).build()).addOption(ProcessedOptionBuilder.builder().name("force").description("Force").type(boolean.class).fieldName("recursive").optionType(OptionType.BOOLEAN).build()).create();
        leaf1Pc.setArgument(ProcessedOptionBuilder.builder().shortName('\u0000').name("").description("Value").type(String.class).fieldName("source").optionType(OptionType.ARGUMENT).build());
        AeshCommandContainer<CommandInvocation> leaf1Container = new AeshCommandContainer<>(leaf1Pc);
        // Leaf 2
        Command<CommandInvocation> leaf2Cmd = AESH_COMMANDS[(index + 3) % AESH_COMMANDS.length].getDeclaredConstructor().newInstance();
        ProcessedCommand<Command<CommandInvocation>, CommandInvocation> leaf2Pc = ProcessedCommandBuilder.<Command<CommandInvocation>, CommandInvocation>builder().name(name + "-leaf2").description("Leaf 2 of " + name).command(leaf2Cmd).addOption(ProcessedOptionBuilder.builder().shortName('f').name("file").description("File path").type(String.class).fieldName("output").optionType(OptionType.NORMAL).build()).addOption(ProcessedOptionBuilder.builder().name("encoding").description("Encoding").type(String.class).fieldName("source").optionType(OptionType.NORMAL).addDefaultValue("UTF-8").build()).create();
        leaf2Pc.setArgument(ProcessedOptionBuilder.builder().shortName('\u0000').name("").description("Data").type(String.class).fieldName("source").optionType(OptionType.ARGUMENT).build());
    ...
    private CommandLine createPicocliProgrammaticNestedGroup(String name) {
        ...
        topSpec.name(name);
        topSpec.addOption(OptionSpec.builder("-g", "--global").type(boolean.class).description("Global flag").build());
        CommandLine top = new CommandLine(topSpec);
        // Mid
        CommandSpec midSpec = CommandSpec.create();
        midSpec.name(name + "-mid");
        midSpec.addOption(OptionSpec.builder("-r", "--region").type(String.class).description("Region").build());
        CommandLine mid = new CommandLine(midSpec);
        // Leaf 1
        CommandSpec leaf1Spec = CommandSpec.create();
        leaf1Spec.name(name + "-leaf1");
        leaf1Spec.addOption(OptionSpec.builder("-n", "--name").type(String.class).description("Name").build());
        leaf1Spec.addOption(OptionSpec.builder("--force").type(boolean.class).description("Force").build());
        leaf1Spec.addPositional(PositionalParamSpec.builder().type(String.class).description("Value").build());
        mid.addSubcommand(name + "-leaf1", new CommandLine(leaf1Spec));
        // Leaf 2
        CommandSpec leaf2Spec = CommandSpec.create();
        leaf2Spec.name(name + "-leaf2");
        leaf2Spec.addOption(OptionSpec.builder("-f", "--file").type(String.class).description("File path").build());
        leaf2Spec.addOption(OptionSpec.builder("--encoding").type(String.class).description("Encoding").defaultValue("UTF-8").build());
        leaf2Spec.addPositional(PositionalParamSpec.builder().type(String.class).description("Data").build());
    ...
    @SuppressWarnings("unused")
    private CommandContainer<CommandInvocation> createGeneratedVarietyContainer(String name, int index) throws Exception {
        Command<CommandInvocation> cmd = AESH_COMMANDS[index % AESH_COMMANDS.length].getDeclaredConstructor().newInstance();
        ProcessedCommandBuilder<Command<CommandInvocation>, CommandInvocation> builder = ProcessedCommandBuilder.<Command<CommandInvocation>, CommandInvocation>builder().name(name).description("Variety " + name).command(cmd).generateHelp(index % 2 == 0).version(index % 3 == 0 ? "1.0.0" : "").addOption(ProcessedOptionBuilder.builder().shortName('i').name("items").description("Items list").type(String.class).fieldName("output").optionType(OptionType.LIST).valueSeparator(',').build()).addOption(ProcessedOptionBuilder.builder().shortName('D').name("properties").description("Properties").type(String.class).fieldName("source").optionType(OptionType.GROUP).build()).addOption(ProcessedOptionBuilder.builder().shortName('v').name("verbose").description("Verbose").type(boolean.class).fieldName("recursive").optionType(OptionType.BOOLEAN).build());
        ProcessedCommand<Command<CommandInvocation>, CommandInvocation> pc = builder.create();
        pc.setArgument(ProcessedOptionBuilder.builder().shortName('\u0000').name("").description("Target").type(String.class).fieldName("source").optionType(OptionType.ARGUMENT).build());
        return new AeshCommandContainer<>(pc);
    }
    ...
    private void buildAeshVarietyReflection(int commandCount) throws Exception {
        ...
        AeshCommandContainerBuilder<CommandInvocation> containerBuilder = new AeshCommandContainerBuilder<>();
        for (int i = 0; i < commandCount; i++) {
            Command<CommandInvocation> cmd = AESH_VARIETY_COMMANDS[i % AESH_VARIETY_COMMANDS.length].getDeclaredConstructor().newInstance();
            CommandContainer<CommandInvocation> container = (CommandContainer<CommandInvocation>) REFLECTION_CREATE.invoke(containerBuilder, cmd);
            registry.addCommand(container);
        }
        AeshCommandRuntimeBuilder.builder().commandRegistry(registry).build();
    ...
    private CommandSpec createPicocliProgrammaticVariety(String name, int index) {
        ...
        spec.addOption(OptionSpec.builder("-i", "--items").type(List.class).splitRegex(",").description("Items list").build());
        spec.addOption(OptionSpec.builder("-D").type(Map.class).description("Properties").build());
        spec.addOption(OptionSpec.builder("-v", "--verbose").type(boolean.class).description("Verbose").build());
        spec.addPositional(PositionalParamSpec.builder().type(String.class).description("Target").build());
        return spec;
    }
